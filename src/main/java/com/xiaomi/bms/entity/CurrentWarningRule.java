...
//@AllArgsConstructor
//@NoArgsConstructor
//@TableName(value="current_warn_rule")
//@ApiModel(description = "电流预警规则")
//public class CurrentWarningRule implements Serializable {
//    /**
//     * 主键ID
//     */
...
//     * 警报等级
//     */
//    @ApiModelProperty(value = "预警等级",example = "0",notes = "预警等级可以是以下值之一：-1, 0, 1, 2, 3")
